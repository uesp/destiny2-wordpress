...
piklist('field', array(
	...
	'fields' => array(
		...
		array(
			...
			'required' => false,
			'label' => 'Arc Grenade Description',
			'columns' => 4,
			'add_more' => false,
			'attributes' => array(
				'placeholder' => 'Place extra arc grenade description here...',
			),
		),
	),
));
...
piklist('field', array(
	...
	'fields' => array(
		...
		array(
			...
			'required' => false,
			'label' => 'Arc Melee Description',
			'columns' => 4,
			'add_more' => false,
			'attributes' => array(
				'placeholder' => 'Place extra arc melee description here...',
			),
		),
	),
));
